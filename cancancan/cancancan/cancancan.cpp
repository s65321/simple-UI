...
BEGIN_MESSAGE_MAP(CcancancanApp, CWinApp)
...
// 唯一一個 CcancancanApp 物件

CcancancanApp theApp;


// CcancancanApp 初始化

BOOL CcancancanApp::InitInstance()
{
